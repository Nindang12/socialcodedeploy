...
"[project]/src/app/likepage/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchLikedPosts = async ()=>{
            try {
                ...
                let currentUser;
                try {
                    const userRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://127.0.0.1:8000/users/me', {
                        headers: {
                ...
                // Lấy tất cả bài viết
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://127.0.0.1:8000/posts', {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
                ...
                const liked = posts.filter((post)=>{
                    ...
                    const likedByIds = post.liked_by.map((id)=>String(id).trim());
                ...
                const likedPostsWithUser = await Promise.all(liked.map(async (post)=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__14872f6c._.js.map