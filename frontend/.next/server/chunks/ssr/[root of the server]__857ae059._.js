...
;
;
function PostCard({ post, user, state, onLike, onRepost, onComment, onClick }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    // Lấy media url đúng cho cả page main và search
    const imageUrl = post.image_id ? `http://127.0.0.1:8000/media/${post.image_id}` : post.image || "";
    const videoUrl = post.video_id ? `http://127.0.0.1:8000/media/${post.video_id}` : post.video || "";
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__857ae059._.js.map