...
function Home() {
    ...
    const handleComment = async (postId, content)=>{
        try {
            await posts.comment(postId, content);
            setPosts(posts.map((post)=>{
                if (post.id === postId) {
                    return {
                        ...post,
...
function Post({ postId, ...post }) {
    ...
    const handleLike = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["posts"].like(postId);
            setLiked(!liked);
    ...
    const handleRepost = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["posts"].repost(postId);
    ...
    const handleComment = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["posts"].comment(postId, newComment);
    ...
    const handleFollowToggle = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`http://127.0.0.1:8000/users/${post.user.username}/${endpoint}`, null, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('token')}`
                }
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e64b092a._.js.map