...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            // Build request body exactly as the FastAPI expects
            const requestBody = {
                phone_number: null,
                email: null,
                username: null,
            ...
            if (err.response) {
                ...
                if (err.response.status === 422) {
                    setError('Dữ liệu không hợp lệ. Vui lòng kiểm tra lại thông tin đăng nhập.');
                } else if (typeof errorData.detail === 'string') {
                    setError(errorData.detail);
                } else if (Array.isArray(errorData.detail)) {
                    setError(errorData.detail[0]?.msg || 'Đăng nhập thất bại');
                } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7272dc48._.js.map