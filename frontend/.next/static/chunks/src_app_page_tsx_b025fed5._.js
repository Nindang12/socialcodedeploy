...
_s(Home, "cc28kxxBSPwTgnMJhcPE4hYwHgw=", false, function() {
    return [
...
function Post({ postId, ...post }) {
    ...
    const [liked, setLiked] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(post.liked_by_me);
    ...
    const [reposted, setReposted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(post.reposted_by_me);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Post.useEffect": ()=>{
            const checkActionStatuses = {
                "Post.useEffect.checkActionStatuses": async ()=>{
                    try {
                        const token = localStorage.getItem('token');
                        if (!token) return;
                        // Check follow status
                        const followResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://127.0.0.1:8000/users/${post.user_id}/follow/status`, {
                            headers: {
                                'Authorization': `Bearer ${token}`
                            }
                        });
            ...
            }["Post.useEffect.checkActionStatuses"];
            checkActionStatuses();
        }
    }["Post.useEffect"], [
        postId,
    ...
    const handleLike = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://127.0.0.1:8000/posts/${postId}/like`, null, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleRepost = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://127.0.0.1:8000/posts/${postId}/repost`, null, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleComment = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://127.0.0.1:8000/posts/${postId}/comments`, {
                content: newComment
            }, {
                headers: {
                    'Authorization': `Bearer ${token}`
    ...
    const handleEditPost = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://127.0.0.1:8000/posts/${postId}`, formData, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'multipart/form-data'
                }
    ...
    const handleDeletePost = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`http://127.0.0.1:8000/posts/${postId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleFollowToggle = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`http://127.0.0.1:8000/users/${post.user_id}/${endpoint}`, null, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
...
_s1(Post, "RGa2DmU6YSZpzbcz/ASg9H0DDdo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
