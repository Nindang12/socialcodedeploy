(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f60b72b5._.js", {
...
const posts = {
    ...
    comment: (postId, content)=>api.post(`/posts/${postId}/comment`, {
            content
        })
};
...
const LoginPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].login({
                identifier,
                password
            });
            router.push('/');
...
_s(LoginPage, "jXWaC3GqIyMRbvvIA+pFOmZaVLo=", false, function() {
    return [
...
//# sourceMappingURL=src_f60b72b5._.js.map